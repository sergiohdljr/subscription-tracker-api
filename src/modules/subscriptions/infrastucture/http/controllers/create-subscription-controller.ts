...
import type { CreateSubscriptionUseCase } from '@/modules/subscriptions/application/use-cases/create-subscription-usecase';
...
export class CreateSubscriptionController {
  ...
  async handle(request: FastifyRequest, reply: FastifyReply) {
    ...
    const { name, price, currency, billingCycle, startDate, trialEndsAt } = parseResult.data;
